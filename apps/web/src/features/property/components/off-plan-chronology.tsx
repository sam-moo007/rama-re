    ...
    <div className="bg-white rounded border p-6">
      ...
      <div className="relative border-l-2 border-slate-200 ml-4 pl-6 space-y-8">
        ...
        <div className="relative">
          <div className="absolute -left-9 top-1 bg-green-100 text-green-700 w-6 h-6 rounded-none flex items-center justify-center">
        ...
        <div className="relative">
          <div className="absolute -left-9 top-1 bg-blue-100 text-blue-700 w-6 h-6 rounded-none flex items-center justify-center">
            <Clock size={14} />
          </div>
          <div>
            <h4 className="font-medium">{t.construction}</h4>
            <p className="text-sm text-slate-600 mt-1">{t.constructionDesc}</p>
            <div className="w-full bg-slate-200 rounded-none h-2 mt-3">
              <div className="bg-blue-600 h-2 rounded-none" style={{ width: '45%' }}></div>
            </div>
          </div>
        </div>

        <div className="relative">
          <div className="absolute -left-9 top-1 bg-amber-100 text-amber-700 w-6 h-6 rounded-none flex items-center justify-center">
        ...
        <div className="relative">
          <div className="absolute -left-9 top-1 bg-slate-100 text-slate-700 w-6 h-6 rounded-none flex items-center justify-center">
            <div className="w-2 h-2 bg-slate-400 rounded-none"></div>
          </div>
          <div>
